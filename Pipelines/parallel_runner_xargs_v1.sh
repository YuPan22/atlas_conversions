...
export vcf_dir=/opt/genomics/ohiaatlasqcEIADA/data/output/20200709_1.1.1e
#export vcf_dir=/opt/genomics/ohiaatlasqcEIADA/data/output/20200617_1.2.1
...
export plink_dir=/opt/genomics/ohiaatlasqcEIADA/data/output/20200709_1.1.1e_plink
mkdir -p ${plink_dir}
...
ls -1 /opt/genomics/azureatlasqccontainer/AtlasQC_WESTUS/iScan\ Scans/204379770103/*.gtc > /home2/yup1/list
