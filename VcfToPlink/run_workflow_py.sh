...
<<OUTPUT
merged.vcf.gz 1.8GB (after decompression, the size of merged.vcf is 7.4GB)
OUTPUT
...
plink_convert.nosex
plink_convert.map 1.8 MB
plink_convert.ped 1.1 GB
plink_convert.log

convert plink to vcf by running
/home2/yup1/vcf_to_plink/plink_linux_x86_64_20200616/plink --file plink_convert --recode vcf --keep-allele-order --real-ref-alleles
The original merged.vcf.gz is 1.8GB (after decompression, the size of merged.vcf is 7.4GB)
The converted plink.vcf size is only 1.1GB.
OUTPUT
